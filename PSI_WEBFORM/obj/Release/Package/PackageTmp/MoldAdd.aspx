...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="table-list1">
        ...
        <tr>
            ...
            <td class="td-control">
                <asp:TextBox ID="txtMachine" runat="server" CssClass="control-input"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="td-control">
                <asp:DropDownList ID="ddlDropDownORG" runat="server" CssClass="control-dropdownlist">
        ...
        <tr>
            ...
            <td colspan="6">
                <asp:Repeater ID="rpMold" runat="server">
                    <HeaderTemplate>
